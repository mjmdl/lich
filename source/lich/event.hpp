...
#define GEN_EVENT_FUNCTIONS(NAME, VARIANT, FLAGS) \
	static Event_Variant static_variant() { \
		return VARIANT; \
	} \
	const char *name() const override { \
		return NAME; \
	} \
	Event_Variant variant() const override { \
		return VARIANT; \
	} \
	Event_Flags flags() const override { \
		return FLAGS; \
	}
